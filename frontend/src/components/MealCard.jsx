...
export default function MealCard({ meal, onDelete }) {
  ...
  return (
    <div className={`${styles.card} ${expanded ? styles.expanded : ""} ${deleting ? styles.deleting : ""}`}>
      <div className={styles.header}>
        <button
          ...
          aria-label={`${meal.meal_type} meal, ${meal.total_calories} calories. ${expanded ? "Collapse" : "Expand"} details`}
        >
        ...
        {onDelete && (
          <button
            ...
            disabled={deleting}
            title="Delete meal"
            aria-label={deleting ? "Deleting meal" : "Delete meal"}
          >
